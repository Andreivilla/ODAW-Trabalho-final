    ...
    function loadJSON(callback) {
      ...
      function createChart(jsonData, exercicio) {
        // Dados do JSON
        ...
        const datas = exercicioData.datas;
        const volumes = exercicioData.volume;
        ...
        new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              label: exercicio,
              data: volumes,
              backgroundColor: getRandomColor(), // Função auxiliar para gerar cores aleatórias
              borderWidth: 1
            }]
          },
          options: {
      ...
      function updateChart() {
        ...
        loadJSON(function(response) {
          createChart(response, exercicioSelecionado);
        });
      }
